...
public class DevRank implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            List<String> devteamCkeys = new ArrayList<>();
            ...
            for (Record rec : forumRecords) {
                ...
                if (allGroups.contains(DEV_TEAM_GROUP)) {
            ...
            logger.info("[DevRank] Finished sync, {} devteam users processed", devteamCkeys.size());
