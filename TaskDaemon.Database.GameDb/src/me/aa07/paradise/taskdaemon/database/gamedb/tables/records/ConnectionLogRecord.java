...
public class ConnectionLogRecord extends UpdatableRecordImpl<ConnectionLogRecord> implements Record7<Integer, LocalDateTime, String, UInteger, String, String, ConnectionLogResult> {
    ...
    @Override
    public Row7<Integer, LocalDateTime, String, UInteger, String, String, ConnectionLogResult> valuesRow() {
    ...
    @Override
    public ConnectionLogRecord value4(UInteger value) {
        setIp(value);
        return this;
    }
    ...
    @Override
    public ConnectionLogRecord values(Integer value1, LocalDateTime value2, String value3, UInteger value4, String value5, String value6, ConnectionLogResult value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ConnectionLogRecord(Integer id, LocalDateTime datetime, String ckey, UInteger ip, String computerid, String serverId, ConnectionLogResult result) {
        super(ConnectionLog.CONNECTION_LOG);
